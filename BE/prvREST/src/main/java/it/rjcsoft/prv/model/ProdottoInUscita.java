...
@Entity(name = "prodotto_in_uscita")
@Where(clause = "tipo = 'PRODOTTO_IN_USCITA'")
//@Subselect("select * from prodotti_dettagli pd where tipo = 'PRODOTTO_IN_USCITA'")
public class ProdottoInUscita {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ProdottoInUscita other = (ProdottoInUscita) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        ...
        builder.append("ProdottoInUscita [aziendaTerza=");
