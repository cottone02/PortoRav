...
public class UtenteDTO {
	...
	public UtenteDTO(Integer id, String firstName, String lastName, String email) {
		super();
		this.userId = id;
	...
	public UtenteDTO(Integer id, String firstName, String lastName, String email, String username) {
		super();
		this.userId = id;
		this.firstName = firstName;
		this.lastName = lastName;
	...
	public UtenteDTO(Integer id, String firstName, String lastName, String username, String password, String email,
			String role) {
		super();
		this.userId = id;
		this.firstName = firstName;
