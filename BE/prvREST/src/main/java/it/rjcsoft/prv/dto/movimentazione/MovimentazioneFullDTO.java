...
public class MovimentazioneFullDTO {
    ...
    private List<DettaglioMovimentazioneDTO> dettagliMovimentazione;
    ...
    public List<DettaglioMovimentazioneDTO> getDettagliMovimentazione() {
        return dettagliMovimentazione;
    }

    public void setDettagliMovimentazione(List<DettaglioMovimentazioneDTO> dettagliMovimentazione) {
    ...
    public String toString() {
        ...
        builder.append("MovimentazioneFullDTO [aziendaTerza=");
